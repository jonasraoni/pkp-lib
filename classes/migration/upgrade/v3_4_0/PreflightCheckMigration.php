...
abstract class PreflightCheckMigration extends \PKP\migration\Migration
{
    ...
    protected function buildOrphanedEntityProcessor(): void
    {
        ...
        $this->addTableProcessor('authors', function (): int {
            ...
            $affectedRows += $this->deleteOptionalReference('authors', 'user_group_id', 'user_groups', 'user_group_id');
            return $affectedRows;
        });
        ...
        $this->addTableProcessor('review_assignments', function (): int {
            ...
            $affectedRows += $this->deleteOptionalReference('review_assignments', 'review_form_id', 'review_forms', 'review_form_id');
            return $affectedRows;
        });
