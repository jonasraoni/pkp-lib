...
{
    /**
     * It define that ALL applied roles to the routes must match be present and associated with the requesting user
     */
    public const ROLES_MATCH_STRICT = 1;
    /**
     * It define that ANY of the applied role to the routes must be present and associated with the requesting user
     */
